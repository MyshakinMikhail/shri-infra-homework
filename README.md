...
Репозиторий, который вы форкнули, должен быть публичным и настроен так, чтобы никто не могу пушить ветку `main`, но любой человек мог:
...
мой IP-адрес -> 89.169.190.56
-> http://89.169.190.56:3000/hw/store
